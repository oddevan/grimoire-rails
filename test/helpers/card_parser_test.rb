...
class CardParserTest < ActiveSupport::TestCase
    ...
    assert_equal '{"name":"Will","type":"Trainer","data":"After playing this card, the next time you flip any coins for an attack, Ability, or Trainer card during this turn, you may choose to make the result heads or tails."}', parsed[:signature_data]
    ...
    assert_equal '{"name":"Will","type":"Trainer","data":"After playing this card, the next time you flip any coins for an attack, Ability, or Trainer card during this turn, you may choose to make the result heads or tails."}', alt_parsed[:signature_data]
